...
public sealed class R2StorageServiceTests
{
    ...
    private static R2Settings Configured() => new()
    {
        ...
        Bucket = "stonehub-media",
        PublicBaseUrl = "https://cdn.stonehub.test",
        UrlExpiryMinutes = 15,
    };
    ...
    public async Task GeneratePresignedUploadUrl_ContainsBucketAndKey()
    {
        ...
        Assert.Contains("stonehub-media", url);
    ...
    public void GetPublicUrl_UsesPublicBaseUrl()
    {
        ...
        Assert.Equal("https://cdn.stonehub.test/uploads/abc/file.jpg", service.GetPublicUrl("uploads/abc/file.jpg"));
    }
}
