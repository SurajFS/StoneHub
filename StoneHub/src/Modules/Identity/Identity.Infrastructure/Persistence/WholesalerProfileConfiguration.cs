...
public sealed class WholesalerProfileConfiguration : IEntityTypeConfiguration<WholesalerProfile>
{
    public void Configure(EntityTypeBuilder<WholesalerProfile> builder)
    {
        builder.ToTable("WholesalerProfiles");
